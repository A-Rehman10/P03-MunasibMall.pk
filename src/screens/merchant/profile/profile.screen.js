  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Option
          title="Statistics"
          imageSource={require('../../../assets/icons/statistics.png')}
          onPress={() => navigation.navigate(SCREENS.VIEW_STATS)}
        />
        <OptionSeparator />
        <Option
          title="Order History"
          imageSource={require('../../../assets/icons/order.png')}
          onPress={() => navigation.navigate(SCREENS.MERCHANT_ORDER_HISTORY)}
        />
        <OptionSeparator />
        <Option
