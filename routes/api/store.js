...
// get stores
// @get request
// endpoint: /api/store/get_popular

router.get("/get_popular", async (req, res) => {
  try {
    const popularStores = await Store.find().limit(3);
...
// get single store
// @get request
// endpoint: /api/store/get_single/:store_id

router.get("/get_single/:store_id", async (req, res) => {
  try {
    const store = await Store.findById(req.params.store_id);
...
// get store feature products
// @get request
// endpoint: /api/store/feature-products/:store_id

router.get("/feature-products/:store_id", async (req, res) => {
  try {
